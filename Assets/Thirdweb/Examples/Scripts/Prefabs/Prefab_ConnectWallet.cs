...
public class Prefab_ConnectWallet : MonoBehaviour
{
    ...
    //public GameObject mirrorUIController;
    string address;
    Wallet wallet;
    ...
    async void OnConnected()
    {
        try
        {
            ...
            //GameObject.FindGameObjectWithTag("LocalPlayer").GetComponent<UI2Network>().setWallet(true);
            GameObject.FindGameObjectWithTag("UIDoc").GetComponent<UI>().ConnectClient(true);
